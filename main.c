...
char stations[34][16]={"Kabankalan City","Himamaylan City","Binalbagan\t","Hinigaran","Pontevedra","Pulupandan","Bago City","Sagay City\t","Talisay City","Silay City","Mabinay\t","Kawayan","Ilog\t","Bais City","Dumaguete City","San Carlos City","Cadiz City","Kanlaon City","Don Salvador","Victorias City\t","Candoni","Dumanggas\t","Oton","Miag-ao\t","Molo","Santa Barbara","Tigbauan","Guimbal","Conception","Zaraga","Leon","San Miguel\t","Pavia City","Roxas City"};
long long int  cPNR;
int check=0;
...
void display_stations(){
    printf("\n\t\t 1.Kabankalan City\t\t18.Kanlaon City");
    printf("\n\t\t 2.Himamaylan City\t\t19.Don Salvador");
    printf("\n\t\t 3.Binalbagan\t\t20.Victorias City");
    printf("\n\t\t 4.Hinigaran\t\t21.Candoni");
    printf("\n\t\t 5.Pontevedra\t\t22.Dumanggas");
    printf("\n\t\t 6.Pulupandan\t\t23.Oton");
    printf("\n\t\t 7.Bago City\t\t24.Miag-ao");
    printf("\n\t\t 8.Sagay City\t\t25.Molo");
    printf("\n\t\t 9.Talisay City\t\t26.Santa Barbara");
    printf("\n\t\t 10.Silay City\t\t27.Tigbauan");
    printf("\n\t\t 11.Mabinay\t\t28.Guimbal");
    printf("\n\t\t 12.Kawayan\t\t29.Conception");
    printf("\n\t\t 13.Ilog\t\t30.Zaraga");
    printf("\n\t\t 14.Bais City\t31.Leon");
    printf("\n\t\t 15.Dumaguete City\t32.San Miguel");
    printf("\n\t\t 16.San Carlos City\t\t33.Pavia City");
    printf("\n\t\t 17.Cadiz City\t\t34.Roxas City\n");
}
...
void startup(){
    ...
    printf("\n\t\t\t   WELCOME TO KARNATAKA RAILWAY SERVICE\n\n");
...
void database(){
    ...
    strcpy(trains[0].name,"Kabankalan One Stop Express");
    ...
    strcpy(trains[1].name,"Iloilo Express");
    ...
    strcpy(trains[2].name,"Bacolod Express");
    ...
    strcpy(trains[3].name,"Kabankalan Express via Talisay");
    ...
    strcpy(trains[4].name,"Bacolod Express via Victorias");
    ...
    strcpy(trains[5].name,"Dumaguete Express via Mabinay");
    ...
    strcpy(trains[6].name,"Silay Superfast Express");
    ...
    strcpy(trains[7].name,"Dumanggas - Oton Express");
    ...
    strcpy(trains[8].name,"San Miguel Superfast Express");
    ...
    strcpy(trains[9].name,"Kabankalan Express via Bago City");
    ...
    strcpy(trains[10].name,"Binalbagan - Cadiz Express");
    ...
    strcpy(trains[11].name,"Don Salvador Express");
